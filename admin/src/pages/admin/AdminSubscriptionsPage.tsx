...
export const AdminSubscriptionsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-100 tracking-tight">SaaS Subscriptions Registry</h1>
        <p className="text-sm text-slate-400 mt-1">Provider-agnostic subscription lifecycle records and plan assignments</p>
      </div>
                  ...
                  return (
                    <tr key={s._id} className="hover:bg-slate-800/30 transition-all">
                      <td className="px-6 py-4 font-semibold text-slate-100">
                        ...
                        <div className="text-xs font-normal text-slate-400">{parent?.email}</div>
                      </td>
